...
const float vertices[] = {  0.0f,  0.5f, 1.0f, 0.0f, 0.0f,
...
int main(int argc, char **argv)
{
	...
	pVertexArray1->bindVertexBuffer(0,
									...
									2, renderer::VertexArrayAttributePointerType::Float, false, 5*sizeof(float), 0*sizeof(float));
	pVertexArray1->bindVertexBuffer(1,
									pVertexArray1->vertexBuffer(0),
									3, renderer::VertexArrayAttributePointerType::Float, false, 5*sizeof(float), 2*sizeof(float));
