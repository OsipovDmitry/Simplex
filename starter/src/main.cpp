...
int main(int argc, char **argv)
{
    ...
    auto w2 = new GLESWidget(nullptr, w1->context()->shareGroup());
    w2->setWindowTitle("Window 2");
    w2->setTransform(glm::translate(glm::mat4x4(), glm::vec3(0.0f, 0.0f, -3.0f)));

    auto w3 = new GLESWidget(nullptr, w1->context()->shareGroup());
    ...
    auto w4 = new GLESWidget(nullptr, w1->context()->shareGroup());
