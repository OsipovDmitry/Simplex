...
ENUMCLASS(
    ...
    uint16_t,
    PositionNormalTexCoordsDataBuffer,
    TangentDataBuffer,
    BoneDataBuffer,
    SkeletonsDataBuffer,
    BonesTransformsDataBuffer,
    ShadowTransformsDataBuffer,
    ShadowDataBuffer,
    ...
    OpaqueShadowDataRenderCommandsBuffer,
    TransparentShadowDataRenderCommandsBuffer,
