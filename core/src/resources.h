...
static const std::filesystem::path RenderDrawDataGeometryPassVertexShaderPath =
    "./resources/shaders/render_drawdata_geometry_pass.vert";
static const std::filesystem::path RenderOpaqueDrawDataGeometryPassFragmentShaderPath =
    "./resources/shaders/render_opaque_drawdata_geometry_pass.frag";
static const std::filesystem::path RenderTransparentDrawDataGeometryPassFragmentShaderPath =
    "./resources/shaders/render_transparent_drawdata_geometry_pass.frag";
...
static const std::filesystem::path RenderDrawDataStencilPassVertexShaderPath =
    "./resources/shaders/render_drawdata_stencil_pass.vert";
static const std::filesystem::path RenderDrawDataStencilPassFragmentShaderPath =
    "./resources/shaders/render_drawdata_stencil_pass.frag";
