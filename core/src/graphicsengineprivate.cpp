...
const std::string& GraphicsEnginePrivate::attributeNameByID(utils::VertexAttribute ID)
{
    ...
    static const std::unordered_map<utils::VertexAttribute, std::string> s_table{
        {utils::VertexAttribute::Position, "a_position"},  {utils::VertexAttribute::Normal, "a_normal"},
        {utils::VertexAttribute::TexCoords, "a_texCoord"}, {utils::VertexAttribute::Tangent, "a_tangent"},
        {utils::VertexAttribute::BonesIDs, "a_bonesIDs"},  {utils::VertexAttribute::BonesWeights, "a_bonesWeights"},
